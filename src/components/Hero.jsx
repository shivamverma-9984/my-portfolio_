                ...
                >
                    ...
                    <div className="flex md:flex-row items-center justify-center gap-3 md:gap-4">
                        <Link
                            ...
                            className=" group bg-primary hover:bg-indigo-600 text-white px-7  md:px-8 py-3 rounded-full font-medium transition-all shadow-lg shadow-indigo-200 hover:shadow-indigo-300 flex items-center"
                        >
                            Download CV
                        ...
                        <Link
                            ...
                            className="bg-white border border-gray-200 hover:border-primary/50 text-text-main hover:text-primary px-8  md:px-10 py-3 rounded-full font-medium transition-all shadow-sm hover:shadow-md"
                        >
                            Contact Me
                        </Link>
                    </div>
