                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <p className="text-text-muted mb-8 leading-relaxed text-lg">
                            ...
                            I am a passionate full-stack developer with 2.5 + years of experience at TCS, specializing in the MERN stack and AWS cloud services. I have worked on building scalable web applications, RESTful APIs, and integrating cloud solutions to optimize performance and reliability. My experience includes collaborating with cross-functional teams, following agile methodologies, and delivering client-centric solutions. I enjoy learning new technologies and applying them to solve real-world problems efficiently. I am committed to writing clean, maintainable code and continuously enhancing my skills to contribute meaningfully to any project.
